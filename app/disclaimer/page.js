...
export const metadata = {
  title: { absolute: "Disclaimer Policy | SkyServer Cloud Technologies" },
  description:
    "Read the Disclaimer Policy of SkyServer Cloud Technologies. Understand the terms of use, liability limitations, and external links disclaimer.",
  alternates: { canonical: "https://skyserver.in/disclaimer" }
};

export default function DisclaimerPage() {
  return (
    <PageShell breadcrumb="Disclaimer Policy">
      <section className="disclaimer-section spad">
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="disclaimer-content">
                <p>
                  <strong>Last updated: December 02, 2024</strong>
                </p>
                ...
                <ul>
                  <li>
                    <strong>Company</strong> (referred to as either &ldquo;SkyServer Cloud Technologies&rdquo;,
                    &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Disclaimer) refers to SkyServer
                    Cloud Technologies.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to SkyServer Cloud Technologies, accessible from{" "}
                    <a href="https://www.skyserver.in" target="_blank" rel="noreferrer">
                      https://www.skyserver.in
                    </a>
                    .
                  </li>
                </ul>
                ...
                <p>
                  ...
                  tort, arising out of or in connection with the use of the Service or the contents of the Service. The
                ...
                <p>
                  The Company is not responsible for any errors or omissions, or for the results obtained from the use
                  of this information.
                </p>
                ...
                <p>
                  The Company believes this constitutes a &ldquo;fair use&rdquo; of any such copyrighted material as
                  provided for in section 107 of the United States Copyright law.
                </p>
                <p>
                  If You wish to use copyrighted material from the Service for your own purposes that go beyond fair
                ...
                <p>
                  ...
                  and reserves the right to delete any comment for any reason whatsoever.
                </p>
                ...
                <p>
                  ...
                  consequential damages whatsoever arising out of or in connection with your access or use or inability
                  to access or use the Service.
                </p>

                <h4>&ldquo;Use at Your Own Risk&rdquo; Disclaimer</h4>
                <p>
                  All information in the Service is provided &ldquo;as is&rdquo;, with no guarantee of completeness,
                ...
                <p>
                  The Company will not be liable to You or anyone else for any decision made or action taken in reliance
                  on the information given by the Service or for any consequential, special or similar damages, even if
                ...
                <ul>
                  <li>
                    By email: <a href="mailto:support@skyserver.in">support@skyserver.in</a>
                  </li>
                </ul>
              </div>
            </div>
